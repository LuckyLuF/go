...
func main(){
	a:=[...]string{"Almond Biscotti Café", "Banana Pudding ", "Balsamic Strawberry (GF)", "Bittersweet Chocolate (GF)", "Blueberry Pancake (GF)", "Bourbon Turtle (GF)",
	"Browned Butte Cookie Dough", "Chocolate Covered Black Cherry (GF)", "Chocolate Fudge Brownie",
